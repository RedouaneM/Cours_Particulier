...
<header id="header" class="container">
	...
	<!--/.nav-collapse -->
	 ...
	 <%String str=(String) request.getAttribute("misenrelation"); 
	   if (str.equals("false")) { %>
	   <div id="main" class="container">
	<div><p><h4>Vous ne pouvez pas suivre votre annonce </h4></p></div>
	</div>
	<%} else {%>
	
	 <%Personne suivi =(Personne) session.getAttribute("suivi"); %>
	<div id="main" class="container">
	<div><p>Félicitations ! <h4><%=suivi.getNom() %></h4> est mis dans votre liste des personnes que vous suivez. </p></div>
	</div>
	<%} %>
