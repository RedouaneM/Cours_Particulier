...
<body>
	...
	<!--/.nav-collapse -->
		...
		<ul class="nav nav-tabs">
		  ...
		  <li role="presentation" class="active"><a href="Main?op=Mes_demandes_de_cours">Mes demandes</a></li>
		  <li role="presentation"><a href="Main?op=Profil"rofil">Profil</a></li>
		</ul>
		</div>
		<div class="jumbotron">
			<p></p>
					...
					<ul class="list-group">
						...
						<li class="list-group-item" style="background-color:#f1f1f1;">
							...
							<div class="8u">
								...
								<a href="Main?op=supprimerDemande&id_annonce=<%=an.getId()%>&url=tableau-de-bord_Mes_demandes" class="btn btn-primary">supprimer l'annonce</a>
							</div>
							</div>
						</li><div><p></p></div>
						<%}%>
